package com.exchange.transaction;
...
import com.exchange.client.model.GatewayModelContext;
import com.exchange.client.model.result.ErrorType;
import com.exchange.client.model.result.ResultType;
import com.exchange.client.model.transaction.CreditCardCustomerType;
import com.exchange.client.model.transaction.DebitType;
import com.exchange.client.model.transaction.TransactionType;
import com.exchange.client.signing.HttpHeaders;
import com.exchange.client.signing.HttpRequestSigner;
import com.exchange.client.signing.Passwords;
...
public class DebitTransaction {
	...
	public static void main(String[] args) throws IOException, JAXBException {
		...
		TransactionType transaction;
		{
			...
			customer.setEmail("customer-email@exchange.com");
	...
	private static HttpURLConnection transactionRequest(String apiKey, String sharedSecret, TransactionType transaction) throws IOException {
		...
		URL url = new URL("https://asxgw.com/transaction");
