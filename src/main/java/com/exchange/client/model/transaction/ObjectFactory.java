 ...
 * generated in the com.exchange.client.model.transaction package. 
...
public class ObjectFactory {
    ...
    private final static QName _Transaction_QNAME = new QName("http://asxgw.com/Schema/V2/Transaction", "transaction");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.exchange.client.model.transaction
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://asxgw.com/Schema/V2/Transaction", name = "transaction")
