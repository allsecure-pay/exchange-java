 ...
 * generated in the com.exchange.client.model.callback package. 
...
public class ObjectFactory {
    ...
    private final static QName _Callback_QNAME = new QName("http://asxgw.com/Schema/V2/Callback", "callback");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.exchange.client.model.callback
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://asxgw.com/Schema/V2/Callback", name = "callback")
