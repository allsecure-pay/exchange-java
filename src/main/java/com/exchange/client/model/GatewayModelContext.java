...
import com.exchange.client.model.callback.CallbackType;
import com.exchange.client.model.options.OptionsType;
import com.exchange.client.model.result.ResultType;
import com.exchange.client.model.schedule.ScheduleRequestType;
import com.exchange.client.model.schedule.ScheduleResultType;
import com.exchange.client.model.status.StatusResultType;
import com.exchange.client.model.status.StatusType;
	...
	private GatewayModelContext() {
		try {
			...
			jaxbContext = JAXBContext.newInstance(
				...
				CallbackType.class,
				com.exchange.client.model.callback.ErrorType.class,
				ResultType.class,
				com.exchange.client.model.result.ErrorType.class,
