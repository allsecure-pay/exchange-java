 ...
 * generated in the com.exchange.client.model.schedule package. 
...
public class ObjectFactory {
    ...
    private final static QName _ScheduleResult_QNAME = new QName("http://asxgw.com/Schema/V2/ScheduleResult", "scheduleResult");
    private final static QName _Schedule_QNAME = new QName("http://asxgw.com/Schema/V2/Schedule", "schedule");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.exchange.client.model.schedule
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://asxgw.com/Schema/V2/ScheduleResult", name = "scheduleResult")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://asxgw.com/Schema/V2/Schedule", name = "schedule")
