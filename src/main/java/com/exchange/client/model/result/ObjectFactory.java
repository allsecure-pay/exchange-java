 ...
 * generated in the com.exchange.client.model.result package. 
...
public class ObjectFactory {
    ...
    private final static QName _Result_QNAME = new QName("http://asxgw.com/Schema/V2/Result", "result");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.exchange.client.model.result
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://asxgw.com/Schema/V2/Result", name = "result")
