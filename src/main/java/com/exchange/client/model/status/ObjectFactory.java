 ...
 * generated in the com.exchange.client.model.status package. 
...
public class ObjectFactory {
    ...
    private final static QName _Status_QNAME = new QName("http://asxgw.com/Schema/V2/Status", "status");
    private final static QName _StatusResult_QNAME = new QName("http://asxgw.com/Schema/V2/StatusResult", "statusResult");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.exchange.client.model.status
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://asxgw.com/Schema/V2/Status", name = "status")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://asxgw.com/Schema/V2/StatusResult", name = "statusResult")
